; (function () {
    ...
    var YearPicker =
        ...
        function (_HTMLElement) {
            _inherits(YearPicker, _HTMLElement);

            function YearPicker() {
                _classCallCheck(this, YearPicker);

                return _possibleConstructorReturn(this, _getPrototypeOf(YearPicker).call(this));
            }
            ...
            _createClass(YearPicker, [{
                ...
                /* 元素生命周期的事件 */
                // 实例化时触发
                value: function createdCallback() { } // console.log('invoked createCallback!');
                // 元素添加到DOM树时触发

            }, {
                key: "attachedCallback",
                value: function attachedCallback() { } // console.log('invoked attachedCallback!');
                // 元素DOM树上移除时触发

            }, {
                key: "detachedCallback",
                value: function detachedCallback() { } // console.log('invoked detachedCallback!');
                // 元素的attribute发生变化时触发
